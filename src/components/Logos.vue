<template>
  <div>
    <a href="https://gitee.com/slamkuntech/wasmusicorelectron" target="_blank">
      <img src="../assets/Wascore.svg" class="logo Wascore" alt="Wascore logo">
    </a>
    <a href="https://gitee.com/slamkuntech/wasmusicorelectron" target="_blank">
      <img src="../assets/logo.svg" class="logo WascoreLogo" alt="WascoreLogo! logo">
    </a>
    <br>
